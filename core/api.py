...
class Api():
    ...
    # 基本函数 #
    def Send_Data(action: str, params: dict, echo=None):
        '''【发送GO-CQ规范的API数据】'''
    ...
    def Random_Echo() -> int:
        ...
        while True:
            ...
            cycle_num += 1
            if Connect.event_dict.get(random_num) == None:
                return random_num
            elif cycle_num >= 512:
                logger.critical(
    ...
    # 消息管理 #
    def send_private_msg(user_id: int, message: str, group_id: int = 0, auto_escape: bool = False, echo=None):
        '''【发送私聊消息】
        user_id:对方QQ号
        message:要发送的内容
